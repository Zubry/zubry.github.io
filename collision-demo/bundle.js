...
var _collisions = require('@zubry/collisions');
...
function drawRectangle(context, rectangle, fill, stroke) {
  var _rectangle$toCoordina = rectangle.toCoordinateList().toArray();
...
function spawnCircles(viewWidth, number) {
  var radius = viewWidth / number / 2;

  return new Array(number).fill(new _boundary.BoundingCircle({ center: new _position2.default({ x: 0, y: radius + 5 }), radius: radius })).map(function (value, index) {
    return value.shift(new _position2.default({ x: 2 * radius * (index + 0.5), y: 0 }));
  });
}

function spawnRectangles() {
  return [new _boundary.BoundingRectangle({
    center: new _position2.default({ x: 195, y: 200 }),
    rotation: new _position2.default(45),
    height: 24,
    width: 192
  }), new _boundary.BoundingRectangle({
    center: new _position2.default({ x: 315, y: 200 }),
    rotation: new _position2.default(-45),
    height: 24,
    width: 192
  })];
...
function onTick(circles, collisions) {
  var delta = new _position2.default({ x: 0, y: 3 });

  var blocked = circles.filter(function (circle) {
    return collisions.detect(circle);
  });
...
function render() {
  ...
  circles.forEach(function (circle) {
    return drawCircle(context, circle, '#1DCCC4', '#3D9995');
  });

  rects.forEach(function (rect) {
    return drawRectangle(context, rect, '#B2D287', '#37664A');
  });
...
var circles = spawnCircles(600, 24);
var rects = spawnRectangles();

var collisions = new _collisions2.default({ items: rects });
...
document.getElementById('reset').addEventListener('click', function () {
  return circles = spawnCircles(600, 24);
});
},{"@zubry/boundary":4,"@zubry/collisions":6,"@zubry/position":12}],2:[function(require,module,exports){
'use strict';
...
},{"./bounding-rectangle":3,"@zubry/position":12,"check-types":15,"immutable":311}],3:[function(require,module,exports){
'use strict';
...
},{"./bounding-circle":2,"@zubry/position":12,"check-types":15,"immutable":311}],4:[function(require,module,exports){
'use strict';
...
},{"./bounding-circle":2,"./bounding-rectangle":3,"babel-polyfill":14}],5:[function(require,module,exports){
'use strict';
...
var CollisionsRecord = (0, _immutable.Record)({
  items: (0, _immutable.List)([])
});

var Collisions = function (_CollisionsRecord) {
  _inherits(Collisions, _CollisionsRecord);

  function Collisions(_ref) {
    var items = _ref.items;

    _classCallCheck(this, Collisions);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(Collisions).call(this, { items: (0, _immutable.List)(items) }));
  }
  ...
  _createClass(Collisions, [{
    ...
    key: 'detect',
    value: function detect(item) {
      return this.items.some(function (i) {
        return item.intersects(i);
      });
    }
  }]);
...
},{"immutable":7}],6:[function(require,module,exports){
'use strict';
...
exports.default = _collisions2.default;
},{"./collisions":5,"babel-polyfill":14}],7:[function(require,module,exports){
/**
...
},{"check-types":10,"immutable":11}],9:[function(require,module,exports){
'use strict';
...
},{"./complex-numbers.js":8,"babel-polyfill":14}],10:[function(require,module,exports){
...
},{"./position":13,"babel-polyfill":14}],13:[function(require,module,exports){
'use strict';
...
},{"@zubry/complexnumber":9,"check-types":15}],14:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":16,"core-js/shim":310,"regenerator-runtime/runtime":313}],15:[function(require,module,exports){
...
arguments[4][7][0].apply(exports,arguments)
},{"dup":7}],312:[function(require,module,exports){
