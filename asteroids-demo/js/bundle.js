...
requestAnimationFrame(draw);
},{"immutable":307,"immutable-quadtrees":300}],2:[function(require,module,exports){
'use strict';

require('./asteroids.js');
},{"./asteroids.js":1}],3:[function(require,module,exports){
(function (global){
...
},{"babel-regenerator-runtime":4,"core-js/fn/regexp/escape":6,"core-js/shim":299}],4:[function(require,module,exports){
...
},{"_process":308}],5:[function(require,module,exports){
...
var _quadtree = require('./modules/quadtree.js');

var _quadtree2 = _interopRequireDefault(_quadtree);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

module.exports = _quadtree2.default;
},{"./modules/quadtree.js":303,"babel-polyfill":3}],301:[function(require,module,exports){
'use strict';
...
var Boundary = function Boundary() {
  function within(bound, item) {
    _checkTypes2.default.assert(_checkTypes2.default.all(['x', 'y', 'width', 'height'].map(function (key) {
    ...
    return item.get('x') >= bound.get('x') && item.get('x') + item.get('width') <= bound.get('x') + bound.get('width') && item.get('y') >= bound.get('y') && item.get('y') + item.get('height') <= bound.get('y') + bound.get('height');
  }

  function intersects(bound1, bound2) {
    _checkTypes2.default.assert(_checkTypes2.default.all(['x', 'y', 'width', 'height'].map(function (key) {
      return bound1.has(key);
    })), 'Missing boundary');
    _checkTypes2.default.assert(_checkTypes2.default.all(['x', 'y', 'width', 'height'].map(function (key) {
      return bound2.has(key);
    })), 'Missing boundary');

    return bound1.get('x') < bound2.get('x') + bound2.get('width') && bound1.get('x') + bound1.get('width') > bound2.get('x') && bound1.get('y') < bound2.get('y') + bound2.get('height') && bound1.get('y') + bound1.get('height') > bound2.get('y');
  }
...
},{"check-types":5}],302:[function(require,module,exports){
'use strict';
...
var _boundary = require('./../structs/boundary.js');

var _boundary2 = _interopRequireDefault(_boundary);

var _node = require('./../structs/node.js');
...
var Node = function Node() {
  var addChild = function addChild(n, item) {
    (0, _checkTypes.assert)(_checkTypes2.default.all(['x', 'y', 'width', 'height'].map(function (key) {
      return item.has(key);
    })), 'Missing boundary');

    (0, _checkTypes.assert)(n.has('children'), 'Missing children property');

    return n.update('children', function (l) {
      return l.push(item);
    });
  };

  var addOverlappingChild = function addOverlappingChild(n, item) {
    (0, _checkTypes.assert)(_checkTypes2.default.all(['x', 'y', 'width', 'height'].map(function (key) {
      return item.has(key);
    })), 'Missing boundary');

    (0, _checkTypes.assert)(n.has('overlappingChildren'), 'Missing overlappingChildren property');

    return n.update('overlappingChildren', function (l) {
      return l.push(item);
    });
  };

  var split = function split(n) {
    (0, _checkTypes.assert)(_checkTypes2.default.all(['x', 'y', 'width', 'height'].map(function (key) {
      return n.get('boundary').has(key);
    })), 'Missing boundary');

    (0, _checkTypes.assert)(_checkTypes2.default.all(['quadrants', 'depth', 'maxDepth', 'maxChildren'].map(function (key) {
      return n.has(key);
    })), 'Missing node properties');

    var _n$get$toObject = n.get('boundary').toObject();

    var x = _n$get$toObject.x;
    var y = _n$get$toObject.y;
    var width = _n$get$toObject.width;
    var height = _n$get$toObject.height;


    var halfwidth = width / 2;
    var halfheight = height / 2;
    var hmid = x + halfwidth;
    var vmid = y + halfheight;
    var depth = n.get('depth') + 1;

    return n.update('quadrants', function (q) {
      return q.set('top-left', (0, _node2.default)((0, _boundary2.default)(x, y, halfheight, halfwidth), n.get('maxChildren'), n.get('maxDepth'), depth)).set('top-right', (0, _node2.default)((0, _boundary2.default)(hmid, y, halfheight, halfwidth), n.get('maxChildren'), n.get('maxDepth'), depth)).set('bottom-left', (0, _node2.default)((0, _boundary2.default)(x, vmid, halfheight, halfwidth), n.get('maxChildren'), n.get('maxDepth'), depth)).set('bottom-right', (0, _node2.default)((0, _boundary2.default)(hmid, vmid, halfheight, halfwidth), n.get('maxChildren'), n.get('maxDepth'), depth));
    });
  };

  var isLeaf = function isLeaf(n) {
    // n is a leaf when its quadrants haven't been set
    (0, _checkTypes.assert)(n.has('quadrants'), 'Missing quadrants property');

    return _checkTypes2.default.null(n.get('quadrants').get('top-left'));
  };

  var clear = function clear(n) {
    var removedNodes = n;

    // If the node has quadrants,
    //   for each quadrant, clear the quadrant
    if (!isLeaf(n)) {
      removedNodes = n.update('quadrants', function (q) {
        return q.map(function (l) {
          return clear(l);
        });
      }).update('quadrants', function (q) {
    ...
    return removedNodes.update('children', function (l) {
      return l.clear();
    }).update('overlappingChildren', function (l) {
      return l.clear();
    });
  };

  var isSplittable = function isSplittable(n) {
    // A node is splittable when:
    //   it has more than the maximum number of children and
    //   it is below the max depth
    _checkTypes2.default.assert(_checkTypes2.default.all(['quadrants', 'depth', 'maxDepth', 'maxChildren'].map(function (key) {
      return n.has(key);
    })), 'Missing node properties');

    var len = n.get('children').count();
  ...
  return {
    addChild: addChild,
    addOverlappingChild: addOverlappingChild,
    split: split,
    clear: clear,
    isLeaf: isLeaf,
...
},{"./../structs/boundary.js":304,"./../structs/node.js":305,"check-types":5}],303:[function(require,module,exports){
'use strict';
...
var _node3 = require('./../structs/node.js');

var _node4 = _interopRequireDefault(_node3);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Quadtree = function Quadtree() {
  function create(boundary) {
    var maxChildren = arguments.length <= 1 || arguments[1] === undefined ? 4 : arguments[1];
    var maxDepth = arguments.length <= 2 || arguments[2] === undefined ? 4 : arguments[2];

    return (0, _node4.default)(boundary, maxChildren, maxDepth, 0);
  }

  function determineQuadrant(n, item) {
    var b = n.get('boundary');

    var right = item.get('x') > b.get('x') + b.get('width') / 2;
    var left = !right;
    var bottom = item.get('y') > b.get('y') + b.get('height') / 2;
    var top = !bottom;
  ...
  function insert(n, item) {
    ...
    (0, _checkTypes.assert)(_checkTypes2.default.all(['boundary', 'quadrants', 'depth', 'maxDepth', 'maxChildren'].map(function (key) {
      return n.has(key);
    })), 'Missing node properties');

    if (!_node2.default.isLeaf(n)) {
      var _ret = function () {
        var direction = determineQuadrant(n, item);
        var quadrant = n.get('quadrants').get(direction);

        if (_boundary2.default.within(quadrant.get('boundary'), item)) {
          return {
            v: n.update('quadrants', function (q) {
              return q.update(direction, function (d) {
                return insert(d, item);
              });
            })
          };
        }
        ...
        return {
          v: _node2.default.addOverlappingChild(n, item)
        };
      }();
    ...
    var updatedNode = _node2.default.addChild(n, item);

    if (!_node2.default.isSplittable(updatedNode)) {
      return updatedNode;
    }

    var splitNode = _node2.default.split(updatedNode);

    var children = splitNode.get('children');

    return children.reduce(function (acc, i) {
      return insert(acc, i);
    }, splitNode).update('children', function (l) {
      return l.clear();
    });
  }
  ...
  function search(n, item) {
    ...
    if (!_boundary2.default.intersects(n.get('boundary'), item)) {
      return (0, _immutable.List)();
    }

    var points = n.get('children').concat(n.get('overlappingChildren')).filter(function (x) {
      return _boundary2.default.intersects(item, x);
    });
    ...
    var quadrants = n.get('quadrants');

    return points.concat(search(quadrants.get('top-left'), item)).concat(search(quadrants.get('top-right'), item)).concat(search(quadrants.get('bottom-left'), item)).concat(search(quadrants.get('bottom-right'), item));
  }

  function clear(n) {
    if (_checkTypes2.default.null(n)) {
      return null;
    }
    ...
    var clearList = function clearList(l) {
      return l.clear();
    };

    return n.update('children', clearList).update('overlappingChildren', clearList).update('quadrants', function (q) {
      return q.update('top-left', clear).update('top-right', clear).update('bottom-left', clear).update('bottom-right', clear).set('top-left', null).set('top-right', null).set('bottom-left', null).set('bottom-right', null);
    });
  }
...
},{"./../structs/node.js":305,"./boundary.js":301,"./node.js":302,"check-types":5,"immutable":307}],304:[function(require,module,exports){
'use strict';
...
function boundary(x, y) {
  ...
  return (0, _immutable.Map)({ width: width, height: height }).merge((0, _position2.default)(x, y));
}

exports.default = boundary;
},{"./position.js":306,"check-types":5,"immutable":307}],305:[function(require,module,exports){
'use strict';
...
function node(boundary) {
  var maxChildren = arguments.length <= 1 || arguments[1] === undefined ? 4 : arguments[1];
  var maxDepth = arguments.length <= 2 || arguments[2] === undefined ? 4 : arguments[2];
  var depth = arguments.length <= 3 || arguments[3] === undefined ? 0 : arguments[3];

  (0, _checkTypes.assert)(_checkTypes2.default.all(['x', 'y', 'width', 'height'].map(function (key) {
    return boundary.has(key);
  })), 'Missing boundary');

  _checkTypes.assert.integer(maxChildren);
  _checkTypes.assert.greater(maxChildren, 0);
  _checkTypes.assert.integer(maxDepth);
  _checkTypes.assert.greater(maxDepth, 0);
  _checkTypes.assert.integer(depth);
  _checkTypes.assert.greaterOrEqual(depth, 0);

  var quadrants = (0, _immutable.Map)({
    'top-left': null,
    'top-right': null,
    'bottom-left': null,
    'bottom-right': null
  ...
  var overlappingChildren = (0, _immutable.List)();

  return (0, _immutable.Map)({ boundary: boundary, maxChildren: maxChildren, maxDepth: maxDepth, depth: depth, quadrants: quadrants, children: children, overlappingChildren: overlappingChildren });
}

exports.default = node;
},{"check-types":5,"immutable":307}],306:[function(require,module,exports){
'use strict';
...
function position() {
  ...
  _checkTypes.assert.number(x);
  _checkTypes.assert.number(y);
...
},{"check-types":5,"immutable":307}],307:[function(require,module,exports){
/**
